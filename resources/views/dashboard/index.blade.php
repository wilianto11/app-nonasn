                ...
                <div class="wallet-footer">
                    <div class="col-3">
                        <div class="card bg-success">
                            <div class="card-body text-center" style="padding: 10px 8px !important; line-height:0.8rem;">
                                <span class="badge badge-light text-dark" style="position:absolute; top:2px; right:5px; font-size:0.7rem; z-index:999;">{{$recapData->sum_presence}}</span>
                    ...
                    <div class="col-3">
                        <div class="card bg-primary">
                            <div class="card-body text-center" style="padding: 10px 8px !important; line-height:0.8rem;">
                                <span class="badge badge-light text-dark" style="position:absolute; top:2px; right:5px; font-size:0.7rem; z-index:999;">{{$recapizin->jmlizin }}</span>
                    ...
                    <div class="col-3">
                        <div class="card bg-warning">
                            <div class="card-body text-center" style="padding: 10px 8px !important; line-height:0.8rem;">
                                <span class="badge badge-light text-dark" style="position:absolute; top:2px; right:5px; font-size:0.7rem; z-index:999;">{{$recapizin->jmlsakit }}</span>
                    ...
                    <div class="col-3">
                        <div class="card bg-danger">
                            <div class="card-body text-center" style="padding: 10px 8px !important; line-height:0.8rem;">
                                <span class="badge badge-light text-dark" style="position:absolute; top:2px; right:5px; font-size:0.7rem; z-index:999;">{{$recapData->sum_late}}</span>
