        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub{{request()->is('perangkatdaerah','pegawai','absensi/cek') ? 'sidebar-item active' : ''}} has-sub">
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item ">
                            <a href="/perangkatdaerah">Perangkat Daerah</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="/pegawai">Pegawai</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="/absensi/cek">Absensi</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item has-sub{{request()->is('absensi/laporan','absensi/laporanabsensi') ? 'sidebar-item active' : ''}} has-sub">
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item ">
                            <a href="/absensi/laporan">Absensi Pegawai</a>
                        </li>
                        <li class="submenu-item ">
                            <a href="/absensi/laporanabsensi">Rekap Laporan</a>
                        </li>
                    </ul>
                </li>
